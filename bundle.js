...
function init() {
  ...
  nextState = createFBO(gl, 500, 512, { 'float': true })
  prevState = createFBO(gl, 512, 500, { 'float': true })
...
function render() {
  ...
  gl.drawElements(gl.TRIANGLES,3, 9)
  ...
  shader.uniforms.uScreen = [shell.width-30, shell.height]
